...
const getGrandTotalData = async(pType) =>
{
...
const getLastGrandTotal = async(pType,pDocDate) =>
{
    return new Promise(async resolve =>
    {
        let tmpQuery = {}
...
const insertGrandTotal = async(pType,pData) =>
{
    return new Promise(async resolve =>
    {
        let tmpPeriod = 0
        ...
        {            
            ...
            let tmpInsertQuery = 
            {
                ...
                value : [pType,tmpPeriod,pData.HT_A.toFixed(2),pData.TTC_A.toFixed(2),pData.HT_B.toFixed(2),pData.TTC_B.toFixed(2),pData.HT_C.toFixed(2),
                         ...
                         (pData.TOTAL_TTC + tmpLastTotal).toFixed(2),signature(tmpLastData)]
            }
...
core.instance.on('onSqlConnected',async(status)=>
{
    // console.log(1)
