...
-- Sparisten faturaya cevrilen urunlerde sadece fiyat degisenlerin görüntülenmesi sağlandı.
...
### MOB
-- Son kullanma tairihinin girilmesi icin Stok icine bir menu yapildi.
-- Dashboard'da  yeni yazim düzenlemesi yapildi.
### BOSS
