...
export default class Login extends React.PureComponent
{
    ...
    async onLoginClick(e)
    {
        ...
        if((await this.core.auth.login(this.state.kullanici,this.state.sifre,'REST')))
        {
                   ...
                   <div className="card-body">
                        ...
                        <div className="dx-field">
                            ...
                            <div className="dx-field-value">
                                ...
                                data={{source:[{id:"en",text:"EN"},{id:"fr",text:"FR"},{id:"tr",text:"TR"},{id:"at",text:"AT"},{id:"de",text:"DE"}]}}
