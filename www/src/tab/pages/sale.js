...
import NdTextBox,{Validator, RequiredRule  } from '../../core/react/devex/textbox'
...
import NdGrid,{Column,Editing,Paging,Pager,Scrolling,KeyboardNavigation,Summary,TotalItem} from '../../core/react/devex/grid.js';
...
export default class Sale extends React.PureComponent
{
    ...
    async init()
    {
        ...
        if(localStorage.getItem("data") != null)
        {
            let tmpConfObj1 =
            {
                id:'msgMemRecord',showTitle:true,title:this.t("msgMemRecord.title"),showCloseButton:true,width:'500px',height:'auto',
    ...
    async customerSearch()
    {
        let tmpSource =
        {
            source : 
            {
                select : 
                {
                    query : `SELECT GUID,CODE,TITLE,NAME,LAST_NAME,[TYPE_NAME],[GENUS_NAME],[PRICE_LIST_NO],VAT_ZERO,BALANCE,(SELECT TOP 1 ADRESS + ' ' + CITY  FROM CUSTOMER_ADRESS_VW_01
                             WHERE CUSTOMER_ADRESS_VW_01.CUSTOMER = CUSTOMER_VW_02.GUID) AS ADRESS FROM CUSTOMER_VW_02 WHERE (UPPER(CODE) LIKE UPPER('%' + @VAL + '%') OR UPPER(TITLE) LIKE UPPER('%' + @VAL + '%')) AND STATUS = 1`,
                    param : ['VAL:string|50'],
    ...
    async getOrders()
    {
        let tmpSource =
        {
            source : 
            {
                select : 
                {
                    query : `SELECT GUID,REF,REF_NO,INPUT_CODE,INPUT_NAME,DOC_DATE_CONVERT,DOC_ADDRESS,TOTAL FROM DOC_VW_01 
                            WHERE TYPE = 1 AND DOC_TYPE = 60 AND REBATE = 0  AND DOC_DATE > dbo.GETDATE()-3 AND CUSER = '` + this.user.CODE + `' ORDER BY DOC_DATE,REF_NO DESC `,
                },
                sql : this.core.sql
            }
        }
    ...
    async getInvoices()
    {
        let tmpSource =
        {
            source : 
            {
                select : 
                {
                    query : `SELECT GUID,REF,REF_NO,INPUT_CODE,INPUT_NAME,DOC_DATE_CONVERT,TOTAL FROM DOC_VW_01 
                            WHERE TYPE = 1 AND DOC_TYPE = 20 AND REBATE = 0 AND DOC_DATE > dbo.GETDATE()-30 ORDER BY DOC_DATE,REF_NO DESC `,
                },
                sql : this.core.sql
            }
        }
    ...
    async orderSave()
    {
        ...
        else
        {
            let tmpConfObj1 =
            {
                id:'msgSaveResult',showTitle:true,title:this.t("msgSave.title"),showCloseButton:true,width:'auto',height:'auto',
    ...
    async factureSave()
    {
        ...
        {                                                    
            ...
            let tmpConfObj2 =
            {
                id:'msgCollection',showTitle:true,title:this.t("msgCollection.title"),showCloseButton:true,width:'500px',height:'auto',
            ...
            if(pResult == 'btn01')
            {
                ...
                this.toast.show({message:this.t("msgCollection.msg"),type:"warning"})
            }
        }
        else
        {
    ...
    async priceListChange()
    {
        ...
        let tmpConfObj1 =
        {
            id:'msgPriceListChange',showTitle:true,title:this.t("msgPriceListChange.title"),showCloseButton:true,width:'500px',height:'auto',
                    ...
                    <ScrollView showScrollbar={'never'} useNative={false} style= {{maxHeight: 'calc(100vh - 100px)'}}>
                                            ...
                                            <Toolbar>
                                                <Item location="after" locateInMenu="auto">
                                                    ...
                                                    onClick={async()=>
                                                    {
                                                        let tmpConfObj1 =
                                                        {
                                                            id:'msgNew',showTitle:true,title:this.t("msgNew.title"),showCloseButton:true,width:'auto',height:'auto',
                                                ...
                                                <Item location="after" locateInMenu="auto">
                                                    ...
                                                    onClick={async()=>
                                                    {
                                                        ...
                                                        if(this.docLines.length == 0)
                                                        {
                                                            this.toast.show({message:this.t("msgLineNotFound.msg"),type:"warning"})
                                                            return
                                                        }
                                                        if(this.docObj.dt()[0].INPUT == "")
                                                        {
                                                            this.toast.show({message:this.t("msgCustomerSelect.msg"),type:"warning"})
                                                            return
                                                        }
                                                        if(this.docObj.dt()[0].OUTPUT == "")
                                                        {
                                                            this.toast.show({message:this.t("msgDepotSelect.msg"),type:"warning"})
                                                            return
                                                        }
                                                        if(this.docType == 60)
                                                        {
                                                ...
                                                <Item location="after" locateInMenu="auto">
                                                    ...
                                                    onClick={async()=>
                                                    {
                                                        ...
                                                        if(pResult == 'btn01')
                                                        {
                                                            if (this.docObj.dt('DOC').length > 0)
                                                            {
                                    ...
                                    <div className='row pt-2'>
                                        <div className='col-12'>
                                            <NdForm colCount={1} > 
                                                {/* txtCustomer */}
                                                <NdItem>
                                                    <NdLabel text={this.t("popCart.txtCustomer")} alignment="right" />
                                                ...
                                                {/* cmbDepot */}
                                                <NdItem>
                                                    <NdLabel text={this.t("popCart.cmbDepot")} alignment="right" />
                                                ...
                                                {/* dtDocDate */}
                                                <NdItem>
                                                    <NdLabel text={this.t("popCart.dtDocDate")} alignment="right" />
                                                ...
                                                {/* dtDShipmentDate */}
                                                <NdItem>
                                                    <NdLabel text={this.t("popCart.dtDShipmentDate")} alignment="right" />
                                                ...
                                                {/* cmbPricingList */}
                                                <NdItem>
                                                    <NdLabel text={this.t("popCart.cmbPricingList")} alignment="right" />
                                                    ...
                                                    onValueChanged={(async()=> { this.priceListChange() }).bind(this)}
                                                    />
                                                </NdItem>
                                                {/* txtDescription */}
                                                <NdItem>
                                                    <NdLabel text={this.t("popCart.txtDescription")} alignment="right" />
                                                ...
                                                <NdItem>
                                                    ...
                                                    width={'100%'}
                                                    dbApply={false}
                                                    onInitialized={(e)=> { this.frmGrdSale = e.component }}
                                                    ...
                                                    >
                                                        ...
                                                        cellRender={(e) => {
                                                            return (
                                                                <div style={{color: e.value <= 0 ? '#FF0000' : 'inherit'}}>
                                                                    {e.text}
                                                                </div>
                                                            )
                                                        }}
                                                        ...
                                                        <Column caption={this.t("grdSale.clmPriceAfterDiscount")} width={90} allowEditing={true}
                                                            ...
                                                            <Form colCount={2} parent={this} id={"frmSale"}>
                                                                ...
                                                                <Item>
                                                                    <NbButton className="form-group btn btn-primary btn-block" style={{backgroundColor:'#154c79',width:'100%'}}
                                                                            onClick={()=> {this.popCustomerExtreReport.show() }}>
                        ...
                        <div>                            
                            <NbPopUp id={"popCustomer"} parent={this} title={""} fullscreen={true} 
                                onHideing={(async()=> { this.getItems() }).bind(this)}>
                                <div>
                                    <div className='row' style={{paddingTop:"10px"}}>
                                                ...
                                                {       
                                                    ...
                                                    if(pResult == 'btn01')
                                                    {
                                                        for (let i = 0; i < this.docLines.length; i++) 
                                                        {
                                                            ...
                                                            this.toast.show({message:this.t("msgVatDelete.msg"),type:"success"})
                                                            this.calculateTotal()
                                                        }
                                ...
                                <Form colCount={1} height={'fit-content'}>
                                    ...
                                    <Item>
                                        <div className='row'>
                                            ...
                                            <div className='col-6'>
                                                <NdButton text={this.t("btnCancel")} type="normal" stylingMode="contained" width={'100%'}
                                                onClick={()=>{ this.popDocDiscount.hide() }}/>
                                            </div>
                                        </div>
                                    </Item>
                                </Form>
                                    ...
                                    <NdItem>
                                        ...
                                        <div className='col-6'>
                                            ...
                                            {    
                                                if(e.validationGroup.validate().status == "valid")
                                                {
                                                    let currentDesignTag = this.cmbDesignList.value;

                                                    await this.popMailSend.show(
                                                    {
                                                        designValue: currentDesignTag,
                                                        singleDocument: true
                                                    });
                        ...
                        <div>
                            ...
                            onShowing={(e) => 
                            {
                                if(e.component._options) 
                                {
                                    this.currentDesignTag = e.component._options.designValue;
                                    this.isSingleDocument = e.component._options.singleDocument;
                                }
                            }}
                            >
                                <NdForm colCount={1} height={'fit-content'}>
                                            ...
                                            <div className='col-6'>
                                                ...
                                                {   
                                                    if(e.validationGroup.validate().status == "valid")
                                                    {
                                                        ...
                                                        let docGuid = this.docObj.dt()[0].GUID;
                                                     
                                                        let tmpQuery = {};

                                                        if(this.docObj.dt()[0].DOC_TYPE == 20 && this.grdFactNonSolde.getSelectedData().length == 0)
                                                        {
                                                            tmpQuery = 
                                                            {
                                                                query: `SELECT *,ISNULL((SELECT TOP 1 PATH FROM LABEL_DESIGN WHERE TAG = @DESIGN),'') AS PATH FROM [dbo].[FN_DOC_ITEMS_FOR_PRINT](@DOC_GUID,@LANG) ORDER BY DOC_DATE,LINE_NO` ,
                                                                param:  ['DOC_GUID:string|50','DESIGN:string|25','LANG:string|10'],
                                                                value:  [docGuid,this.cmbDesignList.value, localStorage.getItem('lang').toUpperCase()]
                                                            }
                                                            let tmpData = await this.core.sql.execute(tmpQuery)
                                                        ...
                                                        else if (this.docObj.dt()[0].DOC_TYPE == 60 && this.grdFactNonSolde.getSelectedData().length == 0)
                                                        {
                                                            tmpQuery = 
                                                            {
                                                                query: `SELECT *,ISNULL((SELECT TOP 1 PATH FROM LABEL_DESIGN WHERE TAG = @DESIGN),'') AS PATH FROM  [dbo].[FN_DOC_ORDERS_FOR_PRINT](@DOC_GUID) ORDER BY LINE_NO` ,
                                                        ...
                                                        if(this.grdFactNonSolde.getSelectedData().length > 0) 
                                                        {
                                                            ...
                                                            for (let i = 0; i < this.grdFactNonSolde.getSelectedData().length; i++) 
                                                            {
                                                                let tmpQuery = 
                                                                {
                                                                    query: `SELECT *,ISNULL((SELECT TOP 1 PATH FROM LABEL_DESIGN WHERE TAG = @DESIGN),'') AS PATH FROM  [dbo].[FN_DOC_ITEMS_FOR_PRINT](@DOC_GUID,@LANG) ORDER BY DOC_DATE,LINE_NO ` ,
                                                                    param:  ['DOC_GUID:string|50','DESIGN:string|25','LANG:string|10'],
                                                                    value:  [this.grdFactNonSolde.getSelectedData()[i].DOC_GUID, this.currentDesignTag || this.cmbDesignList.value, localStorage.getItem('lang').toUpperCase()]
                                                                }
                                                           ...
                                                           this.grdFactNonSolde.devGrid.clearSelection()
                                                        }
                                                        
                                                        if(tmpLines.length > 0 && tmpLines[0] && typeof tmpLines[0].PATH !== 'undefined' && tmpLines[0].PATH !== null) 
                                                        {
                                ...
                                <div className='row' style={{paddingTop:"10px",paddingBottom:"10px"}}>
                                    <div className='col-12' align={"right"}>
                                        <Toolbar>
                                            <Item location="after" locateInMenu="auto">
                                                <NbButton className="form-group btn btn-block btn-outline-dark" style={{backgroundColor:'#f1424a',height:"40px",width:"40px"}}
                                                onClick={()=> { this.popPrintView.hide() }}>
                                                    <i className="fa-solid fa-xmark fa-1x"></i>
                                                </NbButton>
                                            </Item>
                                        </Toolbar>
                        ...
                        <div>
                           ...
                           {/* OpenInvoice  and CustomerExtreReport PopUp */}
                        <div>
                            ...
                            >
                                <Form colCount={1} height={'fit-content'}>
                                    ...
                                    <Item>
                                        <NdButton text={this.t("btnGet")} type="success" width="50%" onClick={this.btnGetirClick} stylingMode="contained" ></NdButton>
                                    </Item>
                                    <Item >
