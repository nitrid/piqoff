...
const ftr_02_004 =
{
    ...
    getContract : "Select Purchase Invoice",
    ...
    grdDiffInv: 
    {
        ...
        clmCustomerPrice : "Supplier Price",
    ...
    msgMoreAmount:
    {
        title: "Attention",
        btn01: "OK",
        msg: "The amount of the remaining balance cannot be paid !"
    },
    msgDiscountPrice:
    {
        title: "Attention",
        btn01: "OK",
        msg: "The amount cannot be discounted !"
    },
    msgDiscountPercent:
    {
        title: "Attention",
    ...
    msgGetLocked:
    {
        title: "Attention",
        btn01: "OK",
        msg: "The document is locked ! \n Please unlock the document with the administrator password to save the changes !"
    },
    msgPayNotDeleted:
    {
        title: "Attention",
    ...
    msgDiscount:
    {
        title: "Attention",
        btn01: "OK",
        msg: "The discount amount cannot be higher than the discount amount !"
    },
    msgItemNotFound:
    {
        title: "Attention",
    ...
    validDepot : "Depo Selection is required",
    validCustomerCode : "Customer Code cannot be empty",
    validDocDate : "Date Selection is required",
    pg_txtBarcode : 
    {
