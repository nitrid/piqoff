...
import NdGrid,{Column, Paging, Pager, GroupPanel, ColumnChooser} from '../../../../core/react/devex/grid.js';
            ...
            source : 
            {
                select : 
                {
                    query : `SELECT 
                            ...
                            FROM PROMO_COND_APP_DELETE_VW_01 WHERE ((CODE LIKE '%' + @CODE + '%') OR (COND_ITEM_CODE LIKE '%' + @CODE + '%') OR 
