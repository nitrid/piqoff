...
export default class priceDiffDemand extends DocBase
{
    ...
    saveState(e)
    {
        let tmpSave = this.access.filter({ELEMENT:'grdDiffOffState',USERS:this.user.CODE,PAGE:this.props.data.id,APP:"OFF"})
        tmpSave.setValue(e)
        tmpSave.save()
    }
    async init()
                    ...
                    <div className="row px-2 pt-2">
                        <div className="col-12">
                            <Toolbar>
                                ...
                                <Item location="after" locateInMenu="auto">
                                    <NdButton id="btnSave" parent={this} icon="floppy" type="success" validationGroup={"frmPriceDiffOff"  + this.tabIndex}
                                    onClick={async (e)=>
                                    {
                                ...
                                <NdItem>
                                    <React.Fragment>
                                        ...
                                        >
                                            ...
                                            <Column dataField="ITEM_CODE" caption={this.t("grdDiffOff.clmItemCode")} width={90} editCellRender={this.cellRoleRender}/>
                                            ...
                                            <Column dataField="QUANTITY" caption={this.t("grdDiffOff.clmQuantity")} dataType={'number'} width={70} editCellRender={this.cellRoleRender}/>
                                            ...
                                            <Column dataField="DISCOUNT" caption={this.t("grdDiffOff.clmDiscount")} dataType={'number'} editCellRender={this.cellRoleRender} format={{ style: "currency", currency: Number.money.code,precision: 2}} width={60} allowHeaderFiltering={false}/>
                                            <Column dataField="DISCOUNT_RATE" caption={this.t("grdDiffOff.clmDiscountRate")} dataType={'number'} width={60} editCellRender={this.cellRoleRender} allowHeaderFiltering={false}/>
