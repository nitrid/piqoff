                            ...
                            <div className="col-4 text-center">
                                    <div 
                                        ...
                                        onClick={async()=>
                                        {
                                            ...
                                            if(pResult == 'btn01')
                                            {
                                                console.log('siparis seçildi')
                                                console.log('this.docObj.dt()[0].GUID',this.docObj.dt()[0].GUID)
                                                console.log('this.docObj.dt()[0].TYPE_TO',this.docObj.dt()[0].TYPE_TO)
