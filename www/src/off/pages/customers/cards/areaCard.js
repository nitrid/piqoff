...
export default class areaCard extends React.PureComponent
{
    ...
    async init()
    {
        ...
        {            
            this.prevCode = this.areaObj.dt().length > 0 ? this.areaObj.dt()[0].CODE : '';
            this.btnBack.setState({disabled:true});
            this.btnNew.setState({disabled:false});
    ...
    async checkSector(pCode)
    {
        return new Promise(async resolve =>
        {
            if(pCode !== '')
            {
                let tmpQuery = 
                {
                    query : `SELECT CODE, NAME FROM CUSTOMER_AREA_VW_01 WHERE CODE = @CODE`,
                        ...
                        <div className="col-12">
                            <NdForm colCount={3} id="frmArea">
                                 ...
                                 <NdItem>
                                    ...
                                    <NdTextBox id="txtCode" parent={this} simple={true} dt={{data:this.areaObj.dt(),field:"CODE"}}  
                                ...
                                <NdItem>
                                    ...
                                    <NdTextBox id="txtTitle" parent={this} simple={true} dt={{data:this.areaObj.dt(),field:"NAME"}}
                                    upper={this.sysParam.filter({ID:'onlyBigChar',USERS:this.user.CODE}).getValue().value}
