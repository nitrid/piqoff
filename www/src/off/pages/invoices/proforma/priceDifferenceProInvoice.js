        ...
        this.pg_contractGrid.onClick = async(data) =>
        {
            ...
            for (let i = 0; i < tmpItems.length; i++)
            {
                for(let x = 0; x < tmpItems[i].length; x++)
                {
                    let tmpQuery = 
                    {
                        query :"SELECT dbo.FN_PRICE(@ITEM,@QUANTITY,dbo.GETDATE(),@CUSTOMER,'00000000-0000-0000-0000-000000000000',0,1,0) AS PRICE",
                                ...
                                <Item>
                                    <React.Fragment>
                                        ...
                                        >
                                            ...
                                            <Column dataField="DISCOUNT" caption={this.t("grdDiffInv.clmDiscount")} dataType={'number'} format={{ style: "currency", currency: Number.money.code,precision: 2}} width={60} allowHeaderFiltering={false}/>
