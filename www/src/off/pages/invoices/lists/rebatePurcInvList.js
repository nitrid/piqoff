            ...
            source : 
            {
                ...
                select : 
                {
                    query : "SELECT * FROM DOC_VW_01 " +
                            ...
                            " AND TYPE = 0 AND DOC_TYPE = 20  AND REBATE = 1 ORDER BY DOC_DATE DESC,REF_NO DESC",
                        ...
                        >
                            <Form colCount={1} height={'fit-content'}>
                                <Item>
                                    ...
                                    value=""
                                    searchEnabled={true}
                                    data={{source:{select:{query : "SELECT TAG,DESIGN_NAME FROM [dbo].[LABEL_DESIGN] WHERE PAGE = '116'"},sql:this.core.sql}}}
                                    >
