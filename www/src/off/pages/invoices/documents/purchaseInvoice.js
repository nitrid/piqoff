                                            ...
                                            {       
                                                ...
                                                if(pResult == 'btn01')
                                                {
                                                    for (let i = 0; i < this.docObj.docItems.dt().length; i++) 
                                                    {
                                                        ...
                                                        this.docObj.docItems.dt()[i].TOTAL = (this.docObj.docItems.dt()[i].PRICE * this.docObj.docItems.dt()[i].QUANTITY) - (this.docObj.docItems.dt()[i].DISCOUNT + this.docObj.docItems.dt()[i].DOC_DISCOUNT)
                                                        this._calculateTotal()
                                                    }
