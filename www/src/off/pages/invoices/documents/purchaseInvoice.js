                        ...
                        <div className="col-12">
                            <Form colCount={3} id={"frmPurcInv"  + this.tabIndex}>
                                ...
                                <Item>
                                    ...
                                    data={{source:{select:{query : "SELECT GUID,REF,REF_NO,OUTPUT_CODE,OUTPUT_NAME,DOC_DATE_CONVERT FROM DOC_VW_01 WHERE TYPE = 0 AND DOC_TYPE = 20 ORDER BY DOC_DATE DESC"},sql:this.core.sql}}}
                                    button=
                                    {
                                        [
                                            {
