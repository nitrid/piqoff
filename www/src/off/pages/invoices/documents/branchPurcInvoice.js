...
export default class branchSaleInvoice extends React.PureComponent
{
    ...
    async _getDispatch()
    {
        ...
        else
        {
            let tmpQuery = 
            {
                query : "SELECT *,REF + '-' + CONVERT(VARCHAR,REF_NO) AS REFERANS FROM DOC_ITEMS_VW_01 WHERE OUTPUT = @OUTPUT AND INVOICE_GUID = '00000000-0000-0000-0000-000000000000' AND TYPE = 0 AND REBATE = 0 AND DOC_TYPE IN(42)",
