...
export default class salesInvoice extends React.PureComponent
{
    ...
    async _calculateTotal()
    {
        ...
        this.docObj.dt()[0].VAT = parseFloat(tmpVat.toFixed(2))+  parseFloat((this.docObj.dt()[0].INTERFEL * 20 /100).toFixed(2))
    ...
    async addItem(pData,pIndex,pQuantity)
    {
        ...
        if(tmpData.result.recordset.length > 0)
        {
            ...
            this.docObj.docItems.dt()[pIndex].VAT = parseFloat((tmpData.result.recordset[0].PRICE * (pData.VAT / 100) * pQuantity).toFixed(4))
