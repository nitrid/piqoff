        ...
        return(
            <div>
                <ScrollView>
                        ...
                        <div className="col-12">
                            <Form colCount={3} id={"frmRebateInv"  + this.tabIndex}>
                                ...
                                <Item>
                                    ...
                                    data={{source:{select:{query : "SELECT GUID,REF,REF_NO,INPUT_CODE,INPUT_NAME,DOC_DATE_CONVERT FROM DOC_VW_01 WHERE TYPE = 1 AND DOC_TYPE = 20 AND REBATE = 1 ORDER BY DOC_DATE DESC"},sql:this.core.sql}}}
                                    button=
                                    {
                                        [
                                            {
                    ...
                    <div className="row px-2 pt-2">
                        <div className="col-12">
                            <Form colCount={4} parent={this} id={"frmRebateInv"  + this.tabIndex}>
                                {/* Ara Toplam */}
                                <EmptyItem colSpan={3}/>
                                <Item  >
                        ...
                        >
                            <Form colCount={1} height={'fit-content'}>
                                ...
                                <Item>
                                    ...
                                    >
                                        <Validator validationGroup={"frmRbtCash"  + this.tabIndex}>
                                ...
                                <Item>
                                    <div className='row'>
                                        <div className='col-6'>
                                            ...
                                            validationGroup={"frmRbtCash"  + this.tabIndex}
                                            onClick={async (e)=>
                                            {       
                                                if(e.validationGroup.validate().status == "valid")
                                                {
                        ...
                        >
                            <Form colCount={1} height={'fit-content'}>
                                ...
                                <Item>
                                    ...
                                    >
                                        <Validator validationGroup={"frmRbtCheck"  + this.tabIndex}>
                                            <RequiredRule message={this.t("ValidCash")} />
                                        </Validator> 
                                    </NdSelectBox>
                                </Item>
                                ...
                                <Item>
                                    <div className='row'>
                                        <div className='col-6'>
                                            ...
                                            validationGroup={"frmRbtCheck"  + this.tabIndex}
                                            onClick={async (e)=>
                                            {       
                                                if(e.validationGroup.validate().status == "valid")
                                                {
                        ...
                        >
                            <Form colCount={1} height={'fit-content'}>
                                ...
                                <Item>
                                    ...
                                    >
                                        <Validator validationGroup={"frmRbtBank"  + this.tabIndex}>
                                ...
                                <Item>
                                    <div className='row'>
                                        <div className='col-6'>
                                            ...
                                            validationGroup={"frmRbtBank"  + this.tabIndex}
                                            onClick={async (e)=>
                                            {       
                                                if(e.validationGroup.validate().status == "valid")
                                                {
