...
export default class mainPage extends React.PureComponent
{
    constructor(props)
    {
        ...
        this.menuItems = [
            ...
            { id: 'slsRpt_01_006', icon: 'fa-solid fa-chart-column', color: '#ffc107', path:'report/sales/customerBasedSaleAndReturnReport' },
            ...
            { id: 'slsRpt_01_013', icon: 'fa-solid fa-sack-dollar', color: '#28a745', path:'report/purchase/customerProfitReport' },
            { id: 'fns_04_005', icon: 'fa-solid fa-magnifying-glass-dollar', color: '#e83e8c', path:'report/finance/collectionReport' },
