...
export default class salesOrder extends React.PureComponent
{
                    ...
                    [
                        {
                            ...
                            onClick:async ()  =>
                            {
                                ...
                                {
                                    this.grdSlsOrder.devGrid.cellValue(e.rowIndex,"QUANTITY",this.txtTotalQuantity.value)
                                    this.grdSlsOrder.devGrid.cellValue(e.rowIndex,"UNIT",this.cmbUnit.value)
                                    this.grdSlsOrder.devGrid.cellValue(e.rowIndex,"UNIT_FACTOR",this.txtUnitFactor.value )
                                });  
                            }
                        },
                    ]
    ...
    async getDocs(pType)
    {
        ...
        if(pType == 0)
        {
            tmpQuery = 
            {
                query : "SELECT GUID,REF,REF_NO,INPUT_CODE,INPUT_NAME,DOC_DATE_CONVERT FROM DOC_VW_01 WHERE TYPE = 1 AND DOC_TYPE = 60 AND REBATE = 0  AND DOC_DATE > GETDATE()-30 ORDER BY DOC_DATE DESC"
            }
        }
        else
        {
                            ...
                            <Form colCount={3} id="frmslsDoc">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-5 ps-0">
                                            ...
                                            onChange={(async()=>
                                            {
                                                let tmpQuery = 
                                                {
                                                    query : "SELECT DELETED FROM DOC WHERE REF = @REF AND REF_NO = @REF_NO AND  TYPE = 1 AND DOC_TYPE = 60 ",
                                ...
                                <Item>
                                    ...
                                    onEnterKey={(async(e)=>
                                    {
                                            ...
                                            let tmpQuery = 
                                            {   query :"SELECT ITEMS_VW_01.GUID,CODE,NAME,COST_PRICE,VAT,BARCODE,ITEMS_VW_01.UNIT,ISNULL((SELECT TOP 1 CODE FROM ITEM_MULTICODE WHERE ITEM_MULTICODE.ITEM = ITEMS_VW_01.GUID AND ITEM_MULTICODE.CUSTOMER = @CUSTOMER AND DELETED = 0 ORDER BY LDATE DESC),'') AS MULTICODE,  " + 
                                                "ISNULL((SELECT TOP 1 CUSTOMER_NAME FROM ITEM_MULTICODE_VW_01 WHERE ITEM_MULTICODE_VW_01.ITEM_GUID = ITEMS_VW_01.GUID ORDER BY LDATE DESC),'') AS CUSTOMER_NAME " + 
                            ...
                            <Form colCount={1} onInitialized={(e)=>
                            {
                                ...
                                <React.Fragment>
                                    ...
                                    >
                                        ...
                                        <Column dataField="ITEM_NAME" caption={this.t("grdSlsOrder.clmItemName")} width={230} />
                                        <Column dataField="ITEM_BARCODE" caption={this.t("grdSlsOrder.clmBarcode")} width={110} allowEditing={false}/>
                                        <Column dataField="QUANTITY" caption={this.t("grdSlsOrder.clmQuantity")} width={70} editCellRender={this._cellRoleRender} dataType={'number'}/>
                                        <Column dataField="PRICE" caption={this.t("grdSlsOrder.clmPrice")} dataType={'number'} format={{ style: "currency", currency: "EUR",precision: 3}}  width={70}/>
                                        <Column dataField="AMOUNT" caption={this.t("grdSlsOrder.clmAmount")} width={90} allowEditing={false} format={{ style: "currency", currency: "EUR",precision: 3}}/>
                                        ...
                                        <Column dataField="DISCOUNT_RATE" caption={this.t("grdSlsOrder.clmDiscountRate")} width={60} dataType={'number'} format={{precision: 2}}/>
