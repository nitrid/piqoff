    ...
    addItem(pData,pIndex,pQuantity,pPrice)
    {
        return new Promise(async resolve =>
        {
            ...
            if(tmpGrpData.result.recordset.length > 0)
            {
                ...
                {
                    this.docObj.docOrders.dt()[pIndex].QUANTITY = pQuantity * this.docObj.docOrders.dt()[pIndex].SUB_FACTOR
                    pQuantity = this.docObj.docOrders.dt()[pIndex].QUANTITY
                }           
            }
            ...
            if(typeof pPrice == 'undefined')
            {
                ...
                else
                {
                    ...
                    this.docObj.docOrders.dt()[pIndex].TOTALHT = 0
                    this.docObj.docOrders.dt()[pIndex].SUB_PRICE = 0
                    this.calculateTotal()
                }
            }
            else
            {
                ...
                this.docObj.docOrders.dt()[pIndex].SUB_PRICE = Number(parseFloat((pPrice).toFixed(4)) * this.docObj.docOrders.dt()[pIndex].SUB_FACTOR).round(2)
                this.calculateTotal()
            }
                                ...
                                <NdItem>
                                    <React.Fragment>
                                        ...
                                        >
                                            ...
                                            <Column dataField="QUANTITY" caption={this.t("grdSlsOrder.clmQuantity")} width={70} dataType={'number'} cellRender={(e)=>{return e.value + " / " + e.data.UNIT_SHORT}} editCellRender={this.cellRoleRender} allowEditing={this.sysParam.filter({ID:'fixedUnitForCondition',USERS:this.user.CODE}).getValue() == true ? false : true}/>
                                            <Column dataField="SUB_FACTOR" caption={this.t("grdSlsOrder.clmSubFactor")} width={70} allowEditing={true} cellRender={(e)=>{return e.value + " / " + e.data.SUB_SYMBOL}}/>
                                        ...
                                        <div className='col-6'>
                                            ...
                                            {       
                                                if(e.validationGroup.validate().status == "valid")
                                                {
                                                    let tmpQuery = 
                                                    {
                                                        query: `SELECT *,ISNULL((SELECT TOP 1 PATH FROM LABEL_DESIGN WHERE TAG = @DESIGN),'') AS PATH FROM  [dbo].[FN_DOC_ORDERS_FOR_PRINT](@DOC_GUID) ORDER BY ITEM_NAME ` ,
                                        ...
                                        onClick={async()=>
                                        {
                                            ...
                                            if(pResult == 'btn01')
                                            {
                                                App.instance.menuClick(
                                                {
                                                    ...
                                                    pagePrm: {orderGuid: this.docObj.dt()[0].GUID, type: 40}
                                                })
                                            }
                                        }}
                                    >
                                        ...
                                        onClick={async()=>
                                        {
                                            ...
                                            if(pResult == 'btn01')
                                            {
                                                App.instance.menuClick(
                                                {
                                                    ...
                                                    pagePrm: {orderGuid: this.docObj.dt()[0].GUID, type: 20}
                                                })
                                            }
                                        }}
                                    >
