...
export default class costEntry extends DocBase
{
    constructor(props)
    {
        super(props)
    ...
    async init()
    {
        ...
        await this.grdDocCostEntry.dataRefresh({source:this.docObj.docCustomer.dt('DOC_CUSTOMER')});
    }
    async getDoc(pGuid,pRef,pRefno)
    {
        this.docObj.clearAll()
        App.instance.loading.show()
        await this.docObj.load({GUID:pGuid,REF:pRef,REF_NO:pRefno,TYPE:1,DOC_TYPE:202});
    ...
    async addCost(pType)
    {
        let tmpDocCustomer = {...this.docObj.docCustomer.empty}
            ...
            this.docObj.dt()[0].OUTPUT = this.cmbBank.value

            if(pType == 30)
            {
                tmpDocCustomer.OUTPUT = this.cmbBank.value
                tmpDocCustomer.OUTPUT_NAME = this.cmbBank.displayValue
                tmpDocCustomer.INPUT = '00000000-0000-0000-0000-000000000000'
                tmpDocCustomer.INPUT_NAME = ''
                tmpDocCustomer.PAY_TYPE = pType
                tmpDocCustomer.AMOUNT = this.txtCostAmount.value
                tmpDocCustomer.DESCRIPTION = this.txtCostDescription.value
            }
        ...
        e.toolbarOptions.items.push({
            ...
            options: {
                ...
                onClick: ((c) => {
                    ...
                    {
                        this.txtCostAmount.value = 0
                        this.txtCostDescription.value = ''
                        this.popCostEntry.show()
                    }
                    else
                    {
        ...
        return(
            <div id={this.props.data.id + this.tabIndex}>
                <ScrollView>
                    ...
                    {/* Form */}
                    <div className="row px-2 pt-1" style={{height:'70px'}}>
                        <div className="col-12">
                                ...
                                <NdItem colSpan={4}>
                                    <React.Fragment>
                                        ...
                                        >
                                            ...
                                            <Column dataField="DESCRIPTION" caption={this.t("grdDocCostEntry.clmDescription")} width={250}/>
                                        </NdGrid>
                                        <ContextMenu
                    ...
                    <div className="row px-2 pt-1">
                      ...
                      {/* Masraf Ödemesi */}
                      <div>
                        <NdPopUp parent={this} id={"popCostEntry"} 
                        visible={false}
                        showCloseButton={true}
                        showTitle={true}
                        title={this.t("popCostEntry.title")}
