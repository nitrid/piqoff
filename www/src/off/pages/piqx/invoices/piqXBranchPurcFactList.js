...
export default class piqXBranchPurcFactList extends React.PureComponent
{
    constructor(props)
    {
        super(props)
                                        ...
                                        async(pData) =>
                                        {
                                            if(typeof pData != 'undefined' && typeof pData.err == 'undefined' && pData.length > 0)
                                            {
                                                try
                                                {
                                                    ...
                                                    {
                                                        id: 'ftr_02_008',
                                                        text: this.lang.t('menuOff.ftr_02_008'),
                                                        path: 'invoices/documents/branchPurcInvoice.js',
                                                        pagePrm: {piqx:pData}
                                                    })
                                                }
                                                catch (err) 
