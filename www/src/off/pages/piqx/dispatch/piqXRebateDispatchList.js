...
export default class piqXRebateDispatchList extends React.PureComponent
{
    constructor(props)
    {
        super(props)
    ...
    async btnGetClick()
    {
        if(this.taxId != "")
        {
            this.core.socket.emit('piqXInvoiceList',{taxId:this.taxId,first:moment(this.dtFirst.value).utcOffset(0, true),last:moment(this.dtLast.value).utcOffset(0, true),docType:40,rebate:1},async(pData)=>
            {
                                        ...
                                        async(pData) =>
                                        {
                                            if(typeof pData != 'undefined' && typeof pData.err == 'undefined' && pData.length > 0)
                                            {
                                                try
                                                {
                                                    ...
                                                    {
                                                        id: 'irs_02_003',
                                                        text: this.lang.t('menuOff.irs_02_003'),
