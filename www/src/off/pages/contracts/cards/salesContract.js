                        ...
                        <div className="col-12">
                            <Form colCount={3} id="frmHeader">
                                  ...
                                  <Item>
                                    ...
                                    data={{source:{select:{query : "SELECT REF,REF_NO,ISNULL((SELECT TITLE FROM CUSTOMER_VW_01 WHERE CUSTOMER_VW_01.GUID = SALES_CONTRACT.CUSTOMER),'') FROM SALES_CONTRACT WHERE TYPE = 1 GROUP BY REF,REF_NO,CUSTOMER"},sql:this.core.sql}}}
                                    button=
                                    {
                                        [
                                            {
