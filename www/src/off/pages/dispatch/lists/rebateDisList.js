...
export default class rebateDisList extends React.PureComponent
{
    constructor(props)
    {
        super(props)
                    ...
                    <div className="row px-2 pt-2">
                        <div className="col-12">
                            ...
                            >                            
                                ...
                                <Export fileName={this.lang.t("menuOff.irs_01_003")} enabled={true} allowExportSelectedData={true} />
