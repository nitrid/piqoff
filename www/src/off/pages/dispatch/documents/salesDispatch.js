...
export default class salesDispatch extends React.PureComponent
{
    ...
    {        
        ...
        this.docObj.dt()[0].VAT = Number(tmpVat).round(4)
    ...
    async addItem(pData,pIndex,pQuantity,pPrice)
    {
        ...
        else
        {
            ...
            this.docObj.docItems.dt()[pIndex].TOTAL = parseFloat((this.docObj.docItems.dt()[pIndex].TOTALHT + this.docObj.docItems.dt()[pIndex].VAT).toFixed(4))
            this._calculateTotal()
        }
        //BAĞLI ÜRÜN İÇİN YAPILDI ******************
                            ...
                            <Form colCount={1} onInitialized={(e)=>
                            {
                                ...
                                <React.Fragment>
                                    ...
                                    onRowUpdated={async(e)=>{
                                        ...
                                        e.key.TOTAL = Number((e.key.TOTALHT + e.key.VAT)).round(4)
