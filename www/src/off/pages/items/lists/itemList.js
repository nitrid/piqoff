                    ...
                    <div className="row px-2 pt-2">
                        <div className="col-12">
                            <NdForm colCount={3} id="frmKriter">
                                ...
                                <NdItem>
                                    <NdLabel text={this.t("txtTotalActive")} alignment="right" />
                                    <NdTextBox id="txtTotalActive" parent={this} simple={true} readOnly={true}/>
                                </NdItem>
                                <NdItem>
                                    <NdLabel text={this.t("txtTotalPassive")} alignment="right" />
