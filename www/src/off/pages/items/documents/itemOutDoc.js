...
export default class itemEntryDoc extends React.PureComponent
{
    ...
    {
        this.docObj.clearAll()
        await this.docObj.load({GUID:pGuid,REF:pRef,REF_NO:pRefno,TYPE:1,DOC_TYPE:0});
                                ...
                                <Item location="after" locateInMenu="auto">
                                    ...
                                    onClick={async ()=>
                                    {
                                        if(this.docObj.dt()[0].LOCKED == 0)
                                        {
                                            ...
                                            if((await this.docObj.save()) == 0)
                                            {
                                                this.toast.show({message:this.t("msgLocked.msg"),type:"warning"})
                                            }
                                            else
                                            {
                        ...
                        <div className="col-12">
                            <NdForm colCount={3} id="frmOutwasFrom">
                                ...
                                <NdItem>
                                    ...
                                    <div className="row">
                                        <div className="col-6 pe-0">
                                            ...
                                            onChange={(async(e)=>
                                            {
                                                let tmpQuery = 
                                                {
                                                    query : `SELECT ISNULL(MAX(REF_NO) + 1,1) AS REF_NO FROM DOC WHERE TYPE = 1 AND DOC_TYPE = 0 AND REF = @REF`,
                                                    param : ['REF:string|25'],
                                    ...
                                    data={{source:{select:{query:`SELECT GUID,REF,REF_NO,OUTPUT_NAME,DOC_DATE_CONVERT FROM DOC_VW_01 WHERE TYPE = 1 AND DOC_TYPE = 0 AND REBATE = 0 ORDER BY DOC_DATE DESC`},sql:this.core.sql}}}
                        ...
                        <div className="col-12">
                            <NdForm colCount={1} onInitialized={(e)=>{this.frmOutwas = e.component}}>
                                <NdItem location="after">
                                    <Button icon="add" validationGroup={"frmOutwasFrom" + this.tabIndex}
                                    onClick={async (e)=>
                                    {
                                        if(e.validationGroup.validate().status == "valid")
                                        {
                                ...
                                <NdItem>
                                    <React.Fragment>    
                                        ...
                                        onRowUpdated={(e)=>{this.calculateTotal()}}
                                        onRowRemoved={(e)=>{this.calculateTotal()}}
                                        >
                        ...
                        source:
                        {
                            select:
                            {
                                query : `SELECT 
                                        ...
                                        FROM ITEMS_VW_04 AS ITEMS INNER JOIN ITEM_BARCODE_VW_01 AS BARCODE ON ITEMS.GUID = BARCODE.ITEM_GUID 
