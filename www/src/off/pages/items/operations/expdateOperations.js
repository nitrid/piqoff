    ...
    async _btnGetClick()
    {
        ...
        let tmpSource =
        {
            source : 
            {
                ...
                { 
                    query :"SELECT *, " +
                            "(QUANTITY-DIFF) AS REMAINDER,[dbo].[FN_PRICE](ITEM_GUID,1,GETDATE(),'00000000-0000-0000-0000-000000000000','00000000-0000-0000-0000-000000000000',1,0,0) AS PRICE FROM " +
