...
export default class purchaseInvoiceReport extends React.PureComponent
{
    constructor(props)
    {
        super(props)
        ...
        this.state = 
        {
            columnListValue : ['DOC_DATE','OUTPUT_CODE','OUTPUT_NAME','REF','AMOUNT','DISCOUNT','TOTALHT','VAT','TOTAL']
        }
