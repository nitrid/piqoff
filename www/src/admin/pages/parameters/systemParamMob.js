...
export default class systemParamMob extends React.PureComponent
{
    constructor()
    {
        super()
                ...
                <ScrollView>
                    ...
                    <div>
                        ...
                        >
                            ...
                            <Column dataField="NAME" caption={this.t("pg_UserList.clmCode")} width={300} defaultSortOrder="asc" />
                        </NdPopGrid>
                    </div>
                </ScrollView>
            </div>
