...
export default class elementParamOff extends React.PureComponent
{
    constructor()
    {
        super()
    ...
    async componentDidMount()
    {
        ...
        await this.prmData.load({APP:'OFF',USERS:''})        
                            ...
                            <Form colCount={4} id={"frmFilter" + this.tabIndex}>
                                <Item>
                                    ...
                                    onValueChanged={async(e)=>
                                    {
                                        ...
                                        {
                                            let tmpData = {...pItem} 
                                            tmpData.VALUE = this.prmData.filter({TYPE:2,USERS:e.value == null ? '' : e.value,ID:pItem.ID}).getValue()                                        
                                ...
                                <Item>
                                    ...
                                    onValueChanged={async(e)=>
                                    {
                                        ...
                                        {
                                            let tmpData = {...pItem} 
                                            tmpData.VALUE = this.prmData.filter({TYPE:2,USERS:this.cmbUser.value == null ? '' : this.cmbUser.value,ID:pItem.ID}).getValue()                                        
                                            this.ItemSet(tmpData,this)
                                        })
                                    }}
                                    />
