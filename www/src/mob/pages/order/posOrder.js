...
export default class purchaseOrder extends React.PureComponent
{
    ...
    render()
    {
        return(
            <div>
                <div>
                    <PageBar id={"pageBar"} parent={this} title={this.lang.t("menu.sip_04")} content=
                    {[
                        {
                                                                ...
                                                                source:
                                                                {
                                                                    select:
                                                                    {
                                                                        query : `SELECT GUID,REF,REF_NO,INPUT_CODE,INPUT_NAME,DOC_DATE_CONVERT 
                                                                                FROM DOC_VW_01 WHERE TYPE = 1 AND DOC_TYPE = 62 AND REBATE = 0 
                                    ...
                                    <div className='card mb-2' style={{background: '#ffffff',borderRadius: '8px',boxShadow: '0 2px 8px rgba(0,0,0,0.06)',border: '1px solid #e9ecef',padding: '6px'}}>
                                        ...
                                        <div className='row mb-2'>
                                            ...
                                            <div className='col-8'>
                                                ...
                                                style={{borderRadius: '6px', border: '1px solid #ced4da', fontSize: '12px'}}
