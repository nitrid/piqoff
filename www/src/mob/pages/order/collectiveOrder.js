   ...
   async calcEntry() 
   {
    ...
    render()
    {
        return(
            <div>
                <div>
                    <PageBar id={"pageBar"} parent={this} title={this.lang.t("menu.sip_03")} content=
                    {[
                        {
                                                                ...
                                                                try 
                                                                {
                                                                    let tmpQuery = 
                                                                    {
                                                                        query : `SELECT ISNULL(MAX(REF_NO) + 1,1) AS REF_NO FROM DOC 
                                                                                WHERE TYPE = 0 AND DOC_TYPE = 70 AND REF = @REF `,
                                                                        param : ['REF:string|25'],
                                                                ...
                                                                source:
                                                                {
                                                                    select:
                                                                    {
                                                                        query : `SELECT GUID,REF,REF_NO,INPUT_CODE,INPUT_NAME,DOC_DATE_CONVERT 
                                                                                FROM DOC_VW_01 WHERE TYPE = 0 AND DOC_TYPE = 70 AND REBATE = 0 
                        ...
                        <PageContent id={"Process"}>
                            <div className='row px-2'>
                                <div className='col-12'>
                                    ...
                                    <div className='card summary-card' style={{background: '#ffffff',borderRadius: '8px',boxShadow: '0 2px 8px rgba(0,0,0,0.06)',border: '1px solid #e9ecef',padding: '2px'}}>
                                        <div className='summary-item' style={{display: 'flex',justifyContent: 'space-between',alignItems: 'center',padding: '2px 0',borderBottom: '1px solid #f0f0f0'}}>
                                            ...
                                            <div style={{width: '120px'}}>
                                                ...
                                                style={{borderRadius: '4px',border: '1px solid #ced4da',fontSize: '12px',padding: '6px',textAlign: 'right'}}/>
                                            </div>
                                        </div>
                                        <div className='summary-item' style={{display: 'flex',justifyContent: 'space-between',alignItems: 'center',padding: '2px 0',borderBottom: '1px solid #f0f0f0'}}>
                                        ...
                                        <div className='summary-item total-item' style={{display: 'flex',justifyContent: 'space-between',alignItems: 'center',padding: '2px 0',borderTop: '2px solid #28a745',marginTop: '2px',background: 'linear-gradient(135deg, #e8f5e8 0%, #f0f8f0 100%)'}}>
