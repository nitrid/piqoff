                                ...
                                <div className='col-12'>
                                                        ...
                                                        <div style={{position: 'relative'}}>
                                                            ...
                                                            {{
                                                                source:
                                                                {
                                                                    select:
                                                                    {
                                                                        query : `SELECT GUID,REF,REF_NO,OUTPUT_CODE,OUTPUT_NAME,DOC_DATE_CONVERT 
                                                                                FROM DOC_VW_01 WHERE TYPE = 0 AND DOC_TYPE = 60 AND REBATE = 0 
                                    ...
                                    <div className='row'>
                                        <div className='col-6'>
                                            ...
                                            style={{background: '#007bff',borderRadius: '8px',boxShadow: '0 2px 8px rgba(0,0,0,0.1)',border: 'none',cursor: 'pointer',height: '50px',transition: 'transform 0.2s ease'}}
                                            onClick={this.onClickBarcodeShortcut.bind(this)}>
                                                <div className='card-body text-center py-3' style={{padding: '16px'}}>
                                                    <i className={"fa-solid fa-barcode"} style={{color:'#ffffff', fontSize:'24px', marginBottom:'4px'}}></i>
                                        ...
                                        <div className='col-6'>
                                            <div className='card action-card mb-2' 
                                            style={{background: '#28a745',borderRadius: '8px',boxShadow: '0 2px 8px rgba(0,0,0,0.1)',border: 'none',cursor: 'pointer',height: '50px',transition: 'transform 0.2s ease'}}
                                            onClick={this.onClickProcessShortcut.bind(this)}>
                                                <div className='card-body text-center py-3' style={{padding: '16px'}}>
                                                    <i className={"fa-solid fa-file-lines"} style={{color:'#ffffff', fontSize:'24px', marginBottom:'4px'}}></i>
                                                    <h6 className='text-white mb-0' style={{fontSize:'12px', fontWeight:'600'}}>
                                    ...
                                    <div className='card entry-card mb-2' style={{background: '#ffffff',borderRadius: '8px',boxShadow: '0 2px 8px rgba(0,0,0,0.06)',border: '1px solid #e9ecef',padding: '6px'}}>
                                        ...
                                        {{
                                            source:
                                            {
                                                select:
                                                {
                                                    query : `SELECT CODE,NAME FROM ITEMS_VW_01 WHERE (UPPER(CODE) LIKE UPPER(@VAL) OR 
                                                            UPPER(NAME) LIKE UPPER(@VAL)) AND STATUS = 1`,
                                                    param : ['VAL:string|50']
                                                },
                                                sql:this.core.sql
                                            }
