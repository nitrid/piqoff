        ...
        <div className="row px-2 pt-2">
            <Form colCount={2}>
                ...
                <div className="col-12 px-2 pt-2">
                        <NdTextBox id="txtItem" parent={this} placeholder={this.t("txtItemPlace")}
                        button=
                        {
                        [
                            {
                ...
                {/* txtBarcodeEnter */}
                <Item>
                    <Label text={this.t("txtBarcodeEnter")} alignment="right" />
                    <NdTextBox id="txtBarcodeEnter" parent={this} simple={true}  
                    upper={this.sysParam.filter({ID:'onlyBigChar',USERS:this.user.CODE}).getValue().value}
                    dt=""
                    param={this.param.filter({ELEMENT:'txtBarcodeEnter',USERS:this.user.CODE})}
                    access={this.access.filter({ELEMENT:'txtBarcodeEnter',USERS:this.user.CODE})}
                    >
                    </NdTextBox>
                </Item> 
                <Item>
                    <div className="row">
                        <NdButton text={this.t("btnAddBarcode")} type="default" width="100%" onClick={()=>{this.popPrice.show()}}></NdButton>
                    </div>
                </Item>
            </Form>
            {/* Stok Seçim */}
