                                ...
                                <div className="col-12">
                                                                ...
                                                                try 
                                                                {
                                                                    let tmpQuery = 
                                                                    {
                                                                        query : `SELECT ISNULL(MAX(REF_NO) + 1,1) AS REF_NO FROM DOC 
                                                                                WHERE TYPE = 1 AND DOC_TYPE = 1 AND REF = @REF `,
                                                                        param : ['REF:string|25'],
                                    ...
                                    <div className='row'>
                                        <div className='col-6'>
                                            ...
                                            style={{background: '#007bff',borderRadius: '8px',boxShadow: '0 2px 8px rgba(40,167,69,0.2)',border: 'none',height: '70px',transition: 'all 0.3s ease'}}
                                        ...
                                        <div className='col-6'>
                                            <div className='card action-card mb-2' 
                                            style={{background: '#28a745',borderRadius: '8px',boxShadow: '0 2px 8px rgba(40,167,69,0.2)',border: 'none',height: '70px',transition: 'all 0.3s ease'}}
                            ...
                            <div className='row px-2'>
                                <div className='col-12'>
                                    ...
                                    <div className='card mb-2' style={{background: '#ffffff',borderRadius: '8px',boxShadow: '0 2px 8px rgba(0,0,0,0.06)',border: '1px solid #e9ecef',padding: '12px'}}>
                                        ...
                                        {/* Miktar */}
                                        <div className='form-group mb-2' style={{background: '#f8f9fa',padding: '10px',borderRadius: '6px'}}>
