                        ...
                        <PageContent id={"Main"}>
                            <div className='row px-2'>
                                <div className='col-12'>
                                    {/* Barkod Arama Kartı */}
                                    <div className='card entry-card mb-2' style={{background: '#ffffff',borderRadius: '8px',boxShadow: '0 2px 8px rgba(0,0,0,0.06)',border: '1px solid #e9ecef',padding: '4px'}}>
                                        <div className='card-header' style={{background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)',borderRadius: '6px 6px 0 0',padding: '2px 4px',marginBottom: '2px',color: '#ffffff'}}>
                                        ...
                                        <div className='card-body' style={{padding: '0'}}>
                                            ...
                                            style={{borderRadius: '6px',border: '2px solid #e9ecef',fontSize: '14px',padding: '4px'}}
                                            onKeyUp={(async(e)=>
                                            {
                                    ...
                                    {/* Ürün Bilgi Kartı */}
                                    <div className='card product-info-card mb-2' style={{background: '#ffffff',borderRadius: '8px',boxShadow: '0 2px 8px rgba(0,0,0,0.06)',border: '1px solid #e9ecef',padding: '4px'}}>
                                        <div className='card-header' style={{background: 'linear-gradient(135deg, #28a745 0%, #20c997 100%)',borderRadius: '6px',padding: '2px 4px',marginBottom: '2px',color: '#ffffff'}}>
                                            <h6 className='mb-0' style={{fontSize: '14px', fontWeight: '600'}}>
                                                📦 {this.t("lblItemInfo")}
                                            </h6>
                                        </div>
                                        <div className='product-name' style={{background: '#f8f9fa',borderRadius: '6px',padding: '4px',textAlign: 'center',minHeight: '20px',display: 'flex',alignItems: 'center',justifyContent: 'center'}}>
                                            <NbLabel id="lblItemName" parent={this} value={""} style={{fontSize: '14px',fontWeight: '500',color: '#495057'}}/>
                                        </div>
                                    </div>
                                    {/* Barkod Form Kartı */}
                                    <div className='card form-card mb-2' style={{background: '#ffffff',borderRadius: '8px',boxShadow: '0 2px 8px rgba(0,0,0,0.06)',border: '1px solid #e9ecef',padding: '2px'}}>
                                        <div className='card-body' style={{padding: '0'}}>
                                            <div className='form-group mb-2' style={{background: '#f8f9fa',padding: '2px',borderRadius: '6px',border: '1px solid #dee2e6'}}>
                                            ...
                                            <div className='form-group mb-2' style={{background: '#f8f9fa',padding: '2px 4px',borderRadius: '6px',border: '1px solid #dee2e6'}}>
                                                <label className='form-label' style={{fontSize: '12px',fontWeight: '500',color: '#6c757d',marginBottom: '2px',display: 'block'}}>
                                                    📏 {this.t("lblUnit")}
                                                </label>
                                            ...
                                            <div className='form-group mb-2' style={{background: '#f8f9fa',padding: '2px 4px',borderRadius: '6px',border: '1px solid #dee2e6'}}>
                                                ...
                                                style={{borderRadius: '4px',border: '1px solid #ced4da',fontSize: '12px',padding: '2px',backgroundColor: '#e9ecef'}}
                                                upper={this.sysParam.filter({ID:'onlyBigChar',USERS:this.user.CODE}).getValue().value} />
                                            </div>
                                        </div>
                                    </div>
                                    {/* Kaydet Butonu */}
                                    <div className='card action-card' style={{background: 'linear-gradient(135deg, #28a745 0%, #20c997 100%)',borderRadius: '8px',boxShadow: '0 2px 8px rgba(0,0,0,0.1)',border: 'none',cursor: 'pointer',transition: 'transform 0.2s ease'}}
                                    onClick={() => {this.barcodeSave()}}>
