...
export default class salesDispatch extends React.PureComponent
{
    ...
    createStyledDialog(type, title, message, iconClass) 
    {
        ...
        return (
            <div style={{background: '#ffffff',borderRadius: '12px',padding: '20px',boxShadow: '0 4px 16px rgba(0,0,0,0.1)',border: '1px solid #e9ecef'}}>
                <div style={{display: 'flex',alignItems: 'center',justifyContent: 'center',marginBottom: '16px'}}>
                    <div style={{background: style.background,borderRadius: '50%',width: '48px',height: '48px',display: 'flex',alignItems: 'center',justifyContent: 'center',marginRight: '12px'}}>
                ...
                <div style={{textAlign: 'center',fontSize: '16px',color: '#495057',lineHeight: '1.5',padding: '12px',background: style.contentBg,borderRadius: '8px',border: `1px solid ${style.contentBorder}`}}>
                    {message}
                </div>
            </div>
        );
    ...
    constructor(props)
    {
        ...
        this.alertContent = 
        {
            ...
            content:(
                <div style={{background: '#ffffff',borderRadius: '12px',padding: '20px',boxShadow: '0 4px 16px rgba(0,0,0,0.1)',border: '1px solid #e9ecef'}}>
                    <div style={{display: 'flex',alignItems: 'center',justifyContent: 'center',marginBottom: '16px'}}>
                        <div style={{background: 'linear-gradient(135deg, #ffc107 0%, #e0a800 100%)',borderRadius: '50%',width: '48px',height: '48px',display: 'flex',alignItems: 'center',justifyContent: 'center',marginRight: '12px'}}>
                            <i style={{color: '#ffffff', fontSize: '20px'}} className="fa-solid fa-exclamation-triangle"></i>
                        </div>
                        <div style={{fontSize: '18px',fontWeight: '600',color: '#2c3e50'}}>
                            Uyarı
                        </div>
                    </div>
                    <div style={{textAlign: 'center',fontSize: '16px',color: '#495057',lineHeight: '1.5',padding: '12px',background: '#fff8e1',borderRadius: '8px',border: '1px solid #ffecb3'}}>
        ...
        return new Promise(async resolve => 
        {
            ...
            {                               
                ...
                this.alertContent.content = (
                    <div style={{background: '#ffffff',borderRadius: '12px',padding: '20px',boxShadow: '0 4px 16px rgba(0,0,0,0.1)',border: '1px solid #e9ecef'}}>
                        <div style={{display: 'flex',alignItems: 'center',justifyContent: 'center',marginBottom: '16px'}}>
                            <div style={{background: 'linear-gradient(135deg, #dc3545 0%, #c82333 100%)',borderRadius: '50%',width: '48px',height: '48px',display: 'flex',alignItems: 'center',justifyContent: 'center',marginRight: '12px'}}>
                                <i style={{color: '#ffffff', fontSize: '20px'}} className="fa-solid fa-barcode"></i>
                            </div>
                            <div style={{fontSize: '18px',fontWeight: '600',color: '#2c3e50'}}>
                                Barkod Hatası
                            </div>
                        </div>
                        <div style={{textAlign: 'center',fontSize: '16px',color: '#495057',lineHeight: '1.5',padding: '12px',background: '#fff5f5',borderRadius: '8px',border: '1px solid #fed7d7'}}>
                            {this.t("msgAlert.msgBarcodeNotFound")}
                        </div>
                    </div>
                )
        ...
        if(this.itemDt.length == 0)
        {
            this.alertContent.content = (
                <div style={{background: '#ffffff',borderRadius: '12px',padding: '20px',boxShadow: '0 4px 16px rgba(0,0,0,0.1)',border: '1px solid #e9ecef'}}>
                    ...
                    <div style={{textAlign: 'center',fontSize: '16px',color: '#495057',lineHeight: '1.5',padding: '12px',background: '#fff8e1',borderRadius: '8px',border: '1px solid #ffecb3'}}>
                        {this.t("msgAlert.msgBarcodeCheck")}
                    </div>
                </div>
            )
        ...
        if(this.txtQuantity.value == "" || this.txtQuantity.value == 0 || this.txtQuantity.value > 15000000 || this.txtPrice.value > 15000000)
        {
            this.alertContent.content = (
                <div style={{background: '#ffffff',borderRadius: '12px',padding: '20px',boxShadow: '0 4px 16px rgba(0,0,0,0.1)',border: '1px solid #e9ecef'}}>
                    <div style={{display: 'flex',alignItems: 'center',justifyContent: 'center',marginBottom: '16px'}}>
                        <div style={{background: 'linear-gradient(135deg, #ffc107 0%, #e0a800 100%)',borderRadius: '50%',width: '48px',height: '48px',display: 'flex',alignItems: 'center',justifyContent: 'center',marginRight: '12px'}}>
                            <i style={{color: '#ffffff', fontSize: '20px'}} className="fa-solid fa-calculator"></i>
                        </div>
                        <div style={{fontSize: '18px',fontWeight: '600',color: '#2c3e50'}}>
                            Miktar Kontrolü
                        </div>
                    ...
                    <div style={{textAlign: 'center',fontSize: '16px',color: '#495057',lineHeight: '1.5',padding: '12px',background: '#fff8e1',borderRadius: '8px',border: '1px solid #ffecb3'}}>
                        {this.t("msgAlert.msgQuantityCheck")}
                    </div>
                </div>
            )
            ...
            for (let i = 0; i < this.docObj.docItems.dt().length; i++) 
            {
                if(this.docObj.docItems.dt()[i].ITEM_CODE == this.itemDt[0].CODE)
                {
                    if(prmRowMerge == 2)
                    {
                        ...
                        let tmpConfObj = 
                        {
                            id:'msgCombineItem',showTitle:true,title:this.lang.t("msgCombineItem.title"),showCloseButton:true,width:'400px',height:'auto',
                            ...
                            content:(
                                <div style={{background: '#ffffff',borderRadius: '12px',padding: '20px',boxShadow: '0 4px 16px rgba(0,0,0,0.1)',border: '1px solid #e9ecef'}}>
                                    <div style={{display: 'flex',alignItems: 'center',justifyContent: 'center',marginBottom: '16px'}}>
                                        <div style={{background: 'linear-gradient(135deg, #007bff 0%, #0056b3 100%)',borderRadius: '50%',width: '48px',height: '48px',display: 'flex',alignItems: 'center',justifyContent: 'center',marginRight: '12px'}}>
                                            <i style={{color: '#ffffff', fontSize: '20px'}} className="fa-solid fa-layer-group"></i>
                                        </div>
                                        <div style={{fontSize: '18px',fontWeight: '600',color: '#2c3e50'}}>
                                            Ürün Birleştirme
                                        </div>
                                    </div>
                                    <div style={{textAlign: 'center',fontSize: '16px',color: '#495057',lineHeight: '1.5',padding: '12px',background: '#f8f9fa',borderRadius: '8px',border: '1px solid #dee2e6'}}>
                                        {this.lang.t("msgCombineItem.msg")}
                                    </div>
                                </div>
                            )
                        }
    ...
    async save()
    {
        return new Promise(async resolve => 
        {
            ...
            if((await this.docObj.save()) != 0)
            {
                let tmpConfObj1 =
                {
                    id:'msgSaveResult',showTitle:true,title:this.lang.t("msgSave.title"),showCloseButton:true,width:'400px',height:'auto',
                    button:[{id:"btn01",caption:this.lang.t("msgSave.btn01"),location:'after'}],
                }

                tmpConfObj1.content = (
                    <div style={{background: '#ffffff',borderRadius: '12px',padding: '10px',boxShadow: '0 4px 16px rgba(0,0,0,0.1)',border: '1px solid #e9ecef'}}>
                        <div style={{display: 'flex',alignItems: 'center',justifyContent: 'center',marginBottom: '8px'}}>
                            <div style={{background: 'linear-gradient(135deg, #dc3545 0%, #c82333 100%)',borderRadius: '50%',width: '48px',height: '48px',display: 'flex',alignItems: 'center',justifyContent: 'center',marginRight: '6px'}}>
                                <i style={{color: '#ffffff', fontSize: '20px'}} className="fa-solid fa-times-circle"></i>
                            </div>
                            <div style={{fontSize: '18px',fontWeight: '600',color: '#2c3e50'}}>
                               {this.lang.t("msgSaveResult.title")}
                            </div>
                        </div>
                        <div style={{textAlign: 'center',fontSize: '16px',color: '#495057',lineHeight: '1.5',padding: '6px',background: '#fff5f5',borderRadius: '8px',border: '1px solid #fed7d7'}}>
                            {this.lang.t("msgSaveResult.msgFailed")}
                        </div>
                    </div>
                )
    ...
    async onClickBarcodeShortcut()
    {
        ...
        {
            this.alertContent.content = (
                <div style={{background: '#ffffff',borderRadius: '12px',padding: '4px',boxShadow: '0 4px 16px rgba(0,0,0,0.1)',border: '1px solid #e9ecef'}}>
                    <div style={{display: 'flex',alignItems: 'center',justifyContent: 'center',marginBottom: '2px'}}>
                        <div style={{background: 'linear-gradient(135deg, #ffc107 0%, #e0a800 100%)',borderRadius: '50%',width: '48px',height: '48px',display: 'flex',alignItems: 'center',justifyContent: 'center',marginRight: '6px'}}>
                            <i style={{color: '#ffffff', fontSize: '20px'}} className="fa-solid fa-warehouse"></i>
                        </div>
                        <div style={{fontSize: '18px',fontWeight: '600',color: '#2c3e50'}}>
                            {this.lang.t("msgBarcodeShortcut.title")}
                        </div>
                    </div>
                    <div style={{textAlign: 'center',fontSize: '16px',color: '#495057',lineHeight: '1.5',padding: '12px',background: '#fff8e1',borderRadius: '8px',border: '1px solid #ffecb3'}}>
                        {this.lang.t("msgBarcodeShortcut.msg")}
                    </div>
                </div>
            )
        ...
        if(this.docObj.dt()[0].INPUT == '')
        {
            this.alertContent.content = (
                <div style={{background: '#ffffff',borderRadius: '12px',padding: '10px',boxShadow: '0 4px 16px rgba(0,0,0,0.1)',border: '1px solid #e9ecef'}}>
                    <div style={{display: 'flex',alignItems: 'center',justifyContent: 'center',marginBottom: '8px'}}>
                        <div style={{background: 'linear-gradient(135deg, #ffc107 0%, #e0a800 100%)',borderRadius: '50%',width: '48px',height: '48px',display: 'flex',alignItems: 'center',justifyContent: 'center',marginRight: '6px'}}>
                            <i style={{color: '#ffffff', fontSize: '20px'}} className="fa-solid fa-user"></i>
                        </div>
                        <div style={{fontSize: '18px',fontWeight: '600',color: '#2c3e50'}}>
                            {this.lang.t("msgBarcodeShortcut.client")}
                        </div>
                    </div>
                    <div style={{textAlign: 'center',fontSize: '16px',color: '#495057',lineHeight: '1.5',padding: '12px',background: '#fff8e1',borderRadius: '8px',border: '1px solid #ffecb3'}}>
                        {this.t("msgAlert.msgCustomer")}
                    </div>
                </div>
            )
        ...
        if(this.docObj.dt("DOC_ITEMS").length == 0)
        {
            this.alertContent.content = (
                <div style={{background: '#ffffff',borderRadius: '12px',padding: '20px',boxShadow: '0 4px 16px rgba(0,0,0,0.1)',border: '1px solid #e9ecef'}}>
                    <div style={{display: 'flex',alignItems: 'center',justifyContent: 'center',marginBottom: '16px'}}>
                        <div style={{background: 'linear-gradient(135deg, #ffc107 0%, #e0a800 100%)',borderRadius: '50%',width: '48px',height: '48px',display: 'flex',alignItems: 'center',justifyContent: 'center',marginRight: '12px'}}>
                            <i style={{color: '#ffffff', fontSize: '20px'}} className="fa-solid fa-file-lines"></i>
                        </div>
                        <div style={{fontSize: '18px',fontWeight: '600',color: '#2c3e50'}}>
                            {this.lang.t("msgBarcodeShortcut.title")}
                        </div>
    ...
    render()
    {
        return(
            <div>
                <div>
                    <PageBar id={"pageBar"} parent={this} title={this.lang.t("menu.irs_03")} content=
                    {[
                        {
                        ...
                        <PageContent id={"Main"}>
                            <div className='row px-2'>
                                <div className='col-12'>
                                    <div className='card modern-card mb-2' style={{background: '#ffffff',borderRadius: '8px',boxShadow: '0 2px 8px rgba(0,0,0,0.06)',border: '1px solid #e9ecef',padding: '4px'}}>
                                        <div className='card-body' style={{padding: '0'}}>
                                                                ...
                                                                source:
                                                                {
                                                                    select:
                                                                    {
                                                                        query : `SELECT GUID,REF,REF_NO,INPUT_CODE,INPUT_NAME,DOC_DATE_CONVERT 
                                                                                FROM DOC_VW_01 WHERE TYPE = 1 AND DOC_TYPE = 42 AND REBATE = 0 
                                            ...
                                            <div className='form-group mb-2' style={{background: '#f8f9fa',padding: '6px',borderRadius: '6px',border: '1px solid #dee2e6'}}>
                                                ...
                                                style={{borderRadius: '4px',border: '1px solid #ced4da',fontSize: '12px'}}
                                                    ...
                                                    source:
                                                    {
                                                        select:
                                                        {
                                                            query : `SELECT GUID,CODE,TITLE,NAME,LAST_NAME,[TYPE_NAME],[GENUS_NAME] 
                                                                    FROM CUSTOMER_VW_01 WHERE (UPPER(CODE) LIKE UPPER(@VAL) OR 
                                                                    UPPER(TITLE) LIKE UPPER(@VAL)) AND STATUS = 1`,
                                                            param : ['VAL:string|50']
                                                        },
                                                        sql:this.core.sql
                                                    }
                                            ...
                                            <div className='form-group mb-0' style={{background: '#f8f9fa',padding: '6px',borderRadius: '6px',border: '1px solid #dee2e6'}}>
                                                <label className='form-label' style={{fontSize: '12px',fontWeight: '500',color: '#6c757d',marginBottom: '2px',display: 'block'}}>
                                                    📅 {this.t("lblDate")}
                                                </label>
                                    ...
                                    <div className='row pb-1'>
                                        <div className='col-6 pe-1'>
                                            <div className='card action-card' style={{background: '#007bff',borderRadius: '8px',boxShadow: '0 2px 8px rgba(0,123,255,0.2)',border: 'none',height: '50px',transition: 'all 0.3s ease'}}>
                                        ...
                                        <div className='col-6 ps-1'>
                                            <div className='card action-card' style={{background: '#28a745',borderRadius: '8px',boxShadow: '0 2px 8px rgba(40,167,69,0.2)',border: 'none',height: '50px',transition: 'all 0.3s ease'}}>
                                                <NbButton className="form-group btn btn-primary btn-purple btn-block" style={{height:"100%",width:"100%",background:"transparent",border:"none"}} 
                            ...
                            <div className='row px-2'>
                                <div className='col-12'>
                                    ...
                                    <div className='card entry-card mb-2' style={{background: '#ffffff',borderRadius: '8px',boxShadow: '0 2px 8px rgba(0,0,0,0.06)',border: '1px solid #e9ecef',padding: '6px'}}>
                                        ...
                                        {{
                                            source:
                                            {
                                                select:
                                                {
                                                    query : `SELECT GUID,CODE,NAME,STATUS,
                                                            (SELECT TOP 1 BARCODE FROM ITEM_BARCODE_VW_01 WHERE ITEM_BARCODE_VW_01.ITEM_GUID = ITEMS_VW_01.GUID AND STATUS=1 ) AS BARCODE 
                                        ...
                                        >
                                            ...
                                            <Column dataField="BARCODE" caption={this.lang.t("popItem.clmBarcode")} width={100} />
                                    ...
                                    <div className='card mb-2' style={{background: '#ffffff',borderRadius: '8px',boxShadow: '0 2px 8px rgba(0,0,0,0.06)',border: '1px solid #e9ecef',padding: '6px'}}>
                                        ...
                                        {/* Hesaplanan Değerler */}
                                        <div style={{background: '#f8f9fa',padding: '4px',borderRadius: '6px',border: '1px solid #dee2e6'}}>
                                            <div className='row mb-1'>
                                                <div className='col-4'>
                                                    <span style={{fontSize: '12px', color: '#6c757d'}}>{this.t("lblAmount")}:</span>
                                                </div>
                                                <div className='col-4'>
                                                    <NdTextBox id="txtEntryAmount" parent={this} simple={true} maxLength={32} readOnly={true} 
                                                    dt={{data:this.orderDt,field:"AMOUNT"}}
                                            ...
                                            <div className='row mb-1'>
                                                ...
                                                <div className='col-6'>
                                                    <NdTextBox id="txtEntryDiscount" parent={this} simple={true} maxLength={32} readOnly={true} 
                                            ...
                                            <div className='row mb-1'>
                                                ...
                                                <div className='col-6'>
                                                    <NdTextBox id="txtEntryVat" parent={this} simple={true} maxLength={32} readOnly={true} 
                                                    dt={{data:this.orderDt,field:"VAT"}}
                                                    style={{borderRadius: '4px', border: '1px solid #dee2e6', backgroundColor: '#ffffff', fontSize: '12px', padding: '4px'}}/>
                                                </div>
                                            </div>
                                            <div className='row'>
                                                ...
                                                <div className='col-4'>
                                                    <NdTextBox id="txtEntrySumAmount" parent={this} simple={true} maxLength={32} readOnly={true} 
                                                    dt={{data:this.orderDt,field:"SUM_AMOUNT"}}
                                    ...
                                    <div style={{background: '#28a745',borderRadius: '8px',boxShadow: '0 2px 8px rgba(40,167,69,0.2)'}}>
                                        ...
                                        style={{height: "35px",width: "100%",background: "transparent",border: "none",fontSize: "16px",fontWeight: "600",color: "white"}} 
                        ...
                        <PageContent id={"Process"}>
                            <div className='row px-2'>
                                <div className='col-12'>
                                    ...
                                    style={{background: '#ffffff',borderRadius: '8px',boxShadow: '0 2px 8px rgba(0,0,0,0.06)',border: '1px solid #e9ecef',padding: '4px'}}>
                                        ...
                                        >
                                            ...
                                            <Column dataField="LOT_CODE" caption={this.t("grdList.clmLotCode")} width={100} />
                                    ...
                                    {/* Summary Section */}
                                    <div className='card' style={{background: '#ffffff',borderRadius: '8px',boxShadow: '0 2px 8px rgba(0,0,0,0.06)',border: '1px solid #e9ecef',padding: '6px'}}>
                                        <div className='summary-container' style={{display: 'flex',flexDirection: 'column',gap: '2px'}}>
                                            {/* Amount Row */}
                                            <div className='summary-row' style={{display: 'flex',justifyContent: 'space-between',alignItems: 'center',padding: '6px 12px',background: '#f8f9fa',borderRadius: '6px',border: '1px solid #dee2e6'}}>
                                                <label style={{fontSize: '13px',fontWeight: '500',color: '#495057',margin: '0'}}>
                                                    📊 {this.t("lblAmount")}
                                                </label>
                                                <div style={{width: '120px'}}>
                                                    <NdTextBox id="txtAmount" parent={this} simple={true} readOnly={true} maxLength={32} dt={{data:this.docObj.dt('DOC'),field:"AMOUNT"}}
                                                    style={{borderRadius: '4px',border: '1px solid #ced4da',fontSize: '12px',padding: '4px',backgroundColor: '#ffffff',textAlign: 'right'}}/>
                                                </div>
                                            </div>
                                            {/* Discount Row */}
                                            <div className='summary-row' style={{display: 'flex',justifyContent: 'space-between',alignItems: 'center',padding: '2px 4px',background: '#f8f9fa',borderRadius: '6px',border: '1px solid #dee2e6'}}>
                                                <label style={{fontSize: '13px',fontWeight: '500',color: '#495057',margin: '0'}}>
                                                    🏷️ {this.t("lblDiscount")}
                                                </label>
                                                <div style={{width: '120px'}}>
                                                    <NdTextBox id="txtDocDiscount" parent={this} simple={true} readOnly={true} maxLength={32} dt={{data:this.docObj.dt('DOC'),field:"DISCOUNT"}}
                                                    style={{borderRadius: '4px',border: '1px solid #ced4da',fontSize: '12px',padding: '2px',backgroundColor: '#ffffff',textAlign: 'right'}}
                                                    button={[
                                                        {
                                                            id:'01',
                                                            icon:'more',
                                            ...
                                            {/* Total Row */}
                                            <div className='summary-row' style={{display: 'flex',justifyContent: 'space-between',alignItems: 'center',padding: '4px 6px',background: 'linear-gradient(135deg, #28a745 0%, #20c997 100%)',borderRadius: '6px',border: '2px solid #28a745',boxShadow: '0 2px 8px rgba(40,167,69,0.2)'}}>
                                                <label style={{fontSize: '14px',fontWeight: 'bold',color: '#ffffff',margin: '0'}}>
                                                    💎 {this.t("lblGenAmount")}
                                                </label>
                                                <div style={{width: '120px'}}>
                                                    <NdTextBox id="txtTotal" parent={this} simple={true} readOnly={true} maxLength={32} dt={{data:this.docObj.dt('DOC'),field:"TOTAL"}}
                                                    style={{borderRadius: '4px',border: '2px solid #ffffff',fontSize: '14px',padding: '2px',backgroundColor: '#ffffff',textAlign: 'right',fontWeight: 'bold',color: '#28a745'}}/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className='col-6'>
                                        ...
                                        onValueChanged={(async()=>
                                        {
                                            if( this.txtDocDiscountPercent1.value > 100)
                                            {
                                                let tmpConfObj =
                                                {
                                                    id:'msgDiscountPercent',showTitle:true,title:this.t("msgDiscountPercent.title"),showCloseButton:true,width:'450px',height:'auto',
                                                    button:[{id:"btn01",caption:this.t("msgDiscountPercent.btn01"),location:'after'}],
                                                    content:(
                                                        <div style={{background: '#ffffff',borderRadius: '12px',padding: '20px',boxShadow: '0 4px 16px rgba(0,0,0,0.1)',border: '1px solid #e9ecef'}}>
                                                            <div style={{display: 'flex',alignItems: 'center',justifyContent: 'center',marginBottom: '16px'}}>
                                                                <div style={{background: 'linear-gradient(135deg, #dc3545 0%, #c82333 100%)',borderRadius: '50%',width: '48px',height: '48px',display: 'flex',alignItems: 'center',justifyContent: 'center',marginRight: '12px'}}>
                                                                    <i style={{color: '#ffffff', fontSize: '20px'}} className="fa-solid fa-percent"></i>
                                                                </div>
                                                                <div style={{fontSize: '18px',fontWeight: '600',color: '#2c3e50'}}>
                                                                    {this.lang.t("msgDiscountPercent.title")}
                                                                </div>
                                                            </div>
                                                            <div style={{textAlign: 'center',fontSize: '16px',color: '#495057',lineHeight: '1.5',padding: '12px',background: '#fff5f5',borderRadius: '8px',border: '1px solid #fed7d7'}}>
                                                                {this.t("msgDiscountPercent.msg")}
                                                            </div>
                                                        </div>
                                                    )
                                                }
                                    ...
                                    <div className='col-6'>
                                        ...
                                        onValueChanged={(async()=>
                                        {
                                            if( this.txtDocDiscountPrice1.value > this.docObj.dt()[0].SUBTOTAL)
                                            {
                                                let tmpConfObj =
                                                {
                                                    id:'msgDiscountPrice',showTitle:true,title:this.t("msgDiscountPrice.title"),showCloseButton:true,width:'450px',height:'auto',
