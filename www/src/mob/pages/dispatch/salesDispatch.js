            ...
            if(tmpDocItems.PARTILOT_GUID == '00000000-0000-0000-0000-000000000000')
            {
                let tmpSource =
                {
                    source:
                    {
                        select:
                        {
                            query : `SELECT GUID,LOT_CODE,SKT FROM ITEM_PARTI_LOT_VW_01 
                                    WHERE UPPER(LOT_CODE) LIKE UPPER(@VAL) AND ITEM = '${tmpDocItems.ITEM}'`,
                            param : ['VAL:string|50']
                        },
                        sql:this.core.sql
                    }
        ...
        return(
            <div>
                ...
                <div style={{position:'relative',height:'calc(100vh - 1px)',overflow:'hidden'}}>
                    ...
                    onActivePage={(e)=>{this.pageBar.activePage(e)}}>
                        <PageContent id={"Main"}>
                            <div className='row px-2'>
                                <div className='col-12'>
                                    <div className='card modern-card mb-2' 
                                    style={{background: '#ffffff',borderRadius: '8px',boxShadow: '0 2px 8px rgba(0,0,0,0.06)',border: '1px solid #e9ecef',padding: '6px'}}>
                                                                ...
                                                                source:
                                                                {
                                                                    select:
                                                                    {
                                                                        query : `SELECT GUID,REF,REF_NO,INPUT_CODE,INPUT_NAME,DOC_DATE_CONVERT 
                                                                                FROM DOC_VW_01 WHERE TYPE = 1 AND DOC_TYPE = 40 AND REBATE = 0 
                            ...
                            <div className='row px-2'>
                                <div className='col-12'>
                                    ...
                                    <div style={{background: '#28a745',borderRadius: '8px',boxShadow: '0 2px 8px rgba(40,167,69,0.2)'}}>
                                        ...
                                        style={{height: "35px",width: "100%",background: "transparent",border: "none",fontSize: "14px",fontWeight: "600",color: "white"}} 
                        ...
                        <PageContent id={"Process"}>
                            <div className='row px-2'>
                                <div className='col-12'>
                                    {/* Grid Container */}
                                    <div className='card mb-2' style={{background: '#ffffff',borderRadius: '8px',boxShadow: '0 2px 8px rgba(0,0,0,0.06)',border: '1px solid #e9ecef',padding: '2px'}}>
