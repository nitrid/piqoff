                        ...
                        <div className="row">
                            <div className="col-12">
                                ...
                                >
                                    ...
                                    <Column dataField="QUANTITY" caption={this.lang.t("grdList.QUANTITY")} width={80} cellRender={(e)=>{console.log(e.data.SCALE_MANUEL); return (e.data.SCALE_MANUEL == true ? "M" : "") + e.value + e.data.UNIT_SHORT}} cssClass={"cell-fontsize"}/>
