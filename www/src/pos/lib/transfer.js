    ...
    fetchSchema()
    {
        ...
        [
            ...
            //ITEMS_POS_VW_01
            {
                ...
                {
                    type : "select",
                    query : `SELECT *,dbo.FN_PRICE_SALE(GUID,1,GETDATE(),'00000000-0000-0000-0000-000000000000') AS PRICE FROM ITEMS_POS_VW_01 {0}`,
                    where : `WHERE LDATE >= GETDATE() - 10`
                },
                to : 
                {
            ...
            //POS_DEVICE_VW_01
            {
                ...
                {
                    type : "insert",
                    query : `INSERT OR REPLACE INTO POS_DEVICE_VW_01 (GUID, CDATE, CUSER, LDATE, LUSER, CODE, NAME, LCD_PORT, SCALE_PORT, PAY_CARD_PORT, SCANNER_PORT, PRINT_DESING, SAFE_GUID)
                            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);`,
