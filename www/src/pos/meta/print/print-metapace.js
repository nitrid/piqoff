                    ...
                    else
                    {
                        ...
                        else //NORMAL SATIŞ SATIRLARI
                        {
                            tmpArr.push( 
                            {
                                ...
                                data: (tmpNameArr.length > 1 ? "  " : tmpSaleItem.VAT_TYPE + " ") +
                                    (tmpSaleItem.GUID == "00000000-0000-0000-0000-000000000000" ? (tmpName2 + tmpFactStr).toString().space(35,'s') : (tmpSaleItem.TICKET_REST ? "*" + tmpName2 + tmpFactStr : tmpName2 + tmpFactStr).toString().space(35)) + " " +
                                    (tmpSaleItem.GUID == "00000000-0000-0000-0000-000000000000" ? "" : (tmpSaleItem.SCALE_MANUEL == true ? "(M)" : "") + "" + tmpQt + " " + tmpSaleItem.UNIT_SHORT).space(7,'e') + " " + //SUBTOTAL                            
                            ...
                            if(tmpSaleItem.DISCOUNT != 0)
                            {
                                tmpArr.push( 
                                {
                                    ...
                                    style: "b",
                                    align: "rt",
                                    data: "Remise ".space(45,"s") + (Number(tmpSaleItem.AMOUNT).rate2Num(tmpSaleItem.DISCOUNT,2) + "% - " + parseFloat(tmpSaleItem.DISCOUNT).toFixed(2) + "EUR").space(10,"s")
                                })
                            }
                        }
                    }
