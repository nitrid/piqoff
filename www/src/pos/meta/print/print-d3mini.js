    ...
    return [
        ...
        {       
            ...
            if(data.special.type == 'Fatura')
            {
                ...
                tmpArr.push({font:"a",align:"ct",data:"------------------------------------------------"})
                tmpArr.push({font:"a",style:"b",align:"ct",data: " ".space(48)})
                ...
                tmpArr.push({font:"a",style:"b",align:"lt",data: data.pos[0].CUSTOMER_ZIPCODE.toString().substring(0,5) + " - " + data.pos[0].CUSTOMER_CITY.toString().substring(0,43)})
                tmpArr.push({font:"a",style:"b",align:"lt",data: data.pos[0].CUSTOMER_COUNTRY.toString().substring(0,48)})
                tmpArr.push({font:"a",style:"b",align:"lt",data:"NO TVA : "+ data.pos[0].CUSTOMER_TAX_NO.toString().substring(0,39)})
                tmpArr.push({font:"a",style:"b",align:"lt",data:"SIRET : "+ data.pos[0].CUSTOMER_SIRET.toString().substring(0,39)})
        ...
        ()=>{return {font:"b",align:"lt",pdf:{fontSize:11},data:("Caissier: " + data.pos[0].CUSER).space(24,'e') + ("Caisse: " + data.pos[0].DEVICE).space(24,'s')}},
        //FIS NO BARKODU
        ()=>{return {align:"ct",barcode:data.pos[0].GUID.substring(19,36),options:{width: 1,height:20,position:'OFF'}}},
        ()=>
        {
        ...
        ()=>{return {font:"b",align:"lt",data:" ".space(48)}},
        ()=>
        {
        ...
        ()=>
        {
            ...
            if(data.special.type == 'Repas')
            {
                ...
                tmpArr.push({font:"b",style:"b",align:"ct",data: " ".space(48)})
            }
            else
            {
        ...
        ()=>
        {
            ...
            if(data.special.type != 'Fatura')
            {
                ...
                data:"  " + "".space(16) + " " + "".space(8) + " " + "   Prix".space(11) + " " + "  Prix".space(8)}
            }
            else
            {
                tmpTitle = {font:"b",style:"b",align:"lt",
                pdf:{fontSize:8,grid:[{x:3,charS:0,charE:2,align:'left'},{x:6,charS:2,charE:33,align:'left'},{x:70,charS:34,charE:47},{x:80,charS:40,charE:54},{x:93,charS:55,charE:65}]},
                data:"  " + "".space(16) + " " + "".space(8) + " " + "  Prix HT".space(11) + " " + "  Prix".space(8)}
            }
            return tmpTitle
        },
        // BAŞLIK 2
        ()=>
        {
            ...
            if(data.special.type != 'Fatura')
            {
                ...
                data:"T " + "Libelle".space(16) + " " + "Qte".space(8) + " " + "U ou EUR/kg".space(11) + " " + "Prix EUR".space(8)}
            }
            else if(data.special.type == 'Fatura')
            {
                tmpTitle = {font:"b",style:"bu",align:"lt",
                pdf:{fontSize:8,grid:[{x:3,charS:0,charE:2,align:'left'},{x:6,charS:2,charE:33,align:'left'},{x:65,charS:34,charE:47},{x:80,charS:48,charE:55},{x:91,charS:56,charE:66}]},
                data:"T " + "Libelle".space(16) + " " + "Qte".space(8) + " " + "U ou EUR/kg".space(11) + " " + "T.HT EUR".space(8)}
            }
            return tmpTitle
        },
        // SATIŞ LİSTESİ
            ...
            else
            {
                ...
                data.pospromo.groupBy('PROMO_GUID').forEach(proGrp => 
                {
                        ...
                        if(tmpProSale.length > 0)
                        {
                            ...
                            if(tmpProSale[0].GUID != '00000000-0000-0000-0000-000000000000' && tmpNameArr.length > 1)
                            {
                                tmpArr.push( 
                                {
                                    ...
                                    (tmpProSale[0].GUID == "00000000-0000-0000-0000-000000000000" ? (tmpName1 + tmpFactStr).toString().space(16,'e') : (tmpProSale[0].TICKET_REST ? "*" + tmpName1 + tmpFactStr : tmpName1 + tmpFactStr).toString().space(16,'e'))
                                })
                            }
                            ...
                            if(data.special.type == 'Fatura')
                            {
                                tmpArr.push( 
                                {
                                    ...
                                    data: (tmpNameArr.length > 1 ? "  " : tmpProSale[0].VAT_TYPE + " ") +
                                        (tmpProSale[0].GUID == "00000000-0000-0000-0000-000000000000" ? (tmpName2 + tmpFactStr).toString().space(16,'s') : (tmpProSale[0].TICKET_REST ? "*" + tmpName2 + tmpFactStr : tmpName2 + tmpFactStr).toString().space(16)) + " " +
                    ...
                    tmpArr.push( 
                    {
                        ...
                        style: "b",
                        align: "rt",
                        data: "Remise ".space(30,"s") + ("  -" + parseFloat(tmpRemise).toFixed(2) + "EUR").space(10,"s")
                    })
                });
                //SATIR DETAYI
                data.possale.where({GUID:{'NIN':data.pospromo.toColumnArr('POS_SALE_GUID')}}).forEach(tmpSaleItem =>
                {
                    ...
                    if(tmpSaleItem.GUID != '00000000-0000-0000-0000-000000000000' && tmpNameArr.length > 1)
                    {
                        tmpArr.push( 
                        {
                            ...
                            pdf: {fontSize:8,grid:[{x:3,charS:0,charE:2,align:'left'},{x:6,charS:2,charE:32,align:'left'}]},
                            data: tmpSaleItem.VAT_TYPE + " " + (tmpSaleItem.GUID == "00000000-0000-0000-0000-000000000000" ? (tmpName1 + tmpFactStr).toString().space(16,'e') : (tmpSaleItem.TICKET_REST ? "*" + tmpName1 + tmpFactStr : tmpName1 + tmpFactStr).toString().space(16,'e'))
                        })
                    }
                    ...
                    if(data.special.type == 'Fatura')
                    {
                        tmpArr.push( 
                        {
                            ...
                            data: (tmpNameArr.length > 1 ? "  " : tmpSaleItem.VAT_TYPE + " ") +
                                (tmpSaleItem.GUID == "00000000-0000-0000-0000-000000000000" ? (tmpName2 + tmpFactStr).toString().space(16,'s') : (tmpSaleItem.TICKET_REST ? "*" + tmpName2 + tmpFactStr : tmpName2 + tmpFactStr).toString().space(16)) + " " +
                        ...
                        if(tmpSaleItem.DISCOUNT != 0)
                        {
                            tmpArr.push( 
                            {
                                ...
                                style: "b",
                                align: "rt",
                                data: "Remise ".space(24,"s") + (Number(tmpSaleItem.AMOUNT).rate2Num(tmpSaleItem.DISCOUNT,2) + "% - " + parseFloat(tmpSaleItem.DISCOUNT).toFixed(2) + "EUR").space(16,"s")
                            })
                        }
                    }
                    else
                    {
                        if(tmpSaleItem.GUID == "00000000-0000-0000-0000-000000000000") //SUB TOTAL SATIRI
                        {
                            tmpArr.push( 
                            {
                                ...
                                align: tmpSaleItem.GUID == "00000000-0000-0000-0000-000000000000" ? "rt" : "rt", //SUBTOTAL
                                pdf: {fontSize:8,grid:[{x:3,charS:0,charE:2,align:'left'},{x:6,charS:2,charE:33,align:'left'},{x:80,charS:34,charE:47},{x:90,charS:48,charE:55},{x:100,charS:56,charE:63}]},
                                data: ("Sub Total").space(39,'e') + " " + (parseFloat(tmpSaleItem.AMOUNT).toFixed(2)).space(7,"s")
                            }) 
                        }
        ...
        {font:"a",style:"bu",align:"lt",data:" ".space(48)},
        // ARA TOPLAM - REMIS
        ()=>
        {
            let tmpArr = [];
        ...
        ()=>
        {
            ...
            else if(data.pospay.where({PAY_TYPE:3}).length > 0)
            {
                tmpArr.push(
                {
                    ...
                    align: "lt",
                    pdf: {fontSize:15},
                    data: "Surplus Tic.Rest.".space(17) + (decimal(data.pospay.sum("TICKET_PLUS",2)) + "EUR").space(15,"s")
                });
                tmpArr.push(
                {
                    font: "a",
                    align: "lt",
                    pdf: {fontSize:15},
                    data: "Rendu".space(17) + ("0,00" + "EUR").space(15,"s")
                });
            }
            else if(data.pospay.where({PAY_TYPE:4}).length > 0)
            {
                ...
                tmpArr.push(
                {
                    ...
                    align: "lt",
                    pdf: {fontSize:15},
                    data: "Rendu".space(17) + (decimal(data.pospay.sum("CHANGE",2)) + "EUR").space(15,"s")
                });
            }
            return tmpArr.length > 0 ? tmpArr : undefined
        },
        {font:"b",style:"bu",align:"lt",data:" ".space(48)},
        // VERGİ LİSTESİ
        ()=>
        {
            let tmpArr = [];
            ...
            for (let i = 0; i < tmpVatLst.length; i++) 
            {
                tmpArr.push(
                {
                    font: "b",
                    align: "rt",
                    data: tmpVatLst[i].VAT_TYPE.space(8) + " " +
                        (tmpVatLst[i].VAT_RATE + "%").space(9) + " " +
                        data.possale.where({VAT_TYPE:tmpVatLst[i].VAT_TYPE}).sum('FAMOUNT',2).space(9) + " " + 
                        data.possale.where({VAT_TYPE:tmpVatLst[i].VAT_TYPE}).sum('VAT',2).space(9) + " " + 
                        data.possale.where({VAT_TYPE:tmpVatLst[i].VAT_TYPE}).sum('TOTAL',2).space(9)
                })
            }
            ...
            tmpArr.push(
            {
                ...
                align: "rt",
                data: ("Total : ").space(17) +
                    data.possale.sum('FAMOUNT',2).space(9) + " " + 
                    data.possale.sum('VAT',2).space(9) + " " + 
                    data.possale.sum('TOTAL',2).space(9)
            })
        ...
        ()=>
        {
            if(data.possale.where({TICKET_REST:true}).length > 0)
            {
                return {
                    ...
                    style:"b",
                    align:"lt",
                    data:"(*) TOTAL ART ELIGIBLE".space(36) + " " + 
                    (data.possale.where({TICKET_REST:true}).sum('TOTAL',2)+ "EUR").space(7,"s") 
                }
            }
        },
        // SCALE_MANUEL
        {font:"b",style:"a",align:"lt",data:"(M) POIDS ENTRE MANUELLEMENT *Article(s)".space(36)},
        {font:"b",style:"bu",align:"lt",data:" ".space(48)},
        ...
        ()=>
        {
            ...
            {            
                if(data.pos[0].CUSTOMER_POINT_PASSIVE == false)
                {
                    ...
                    tmpArr.push({font:"b",style:"b",align:"lt",data:"************************************************".space(48)});
                    tmpArr.push({font:"b",align:"lt",data:("CARTE DE FIDELITE / " + data.pos[0].CUSTOMER_CODE + " / " + data.pos[0].CUSTOMER_NAME).space(48)});
                    ...
                    if(data.special.customerUsePoint > 0)
                    {
                        tmpArr.push({font:"b",align:"lt",data:"UTILISE POINT ".space(40) + ((parseInt(data.special.customerUsePoint) * -1) + ' Pts').space(8,"s")});
                    }
                    tmpArr.push({font:"b",align:"lt",data:"NOUVEAU CUMUL ".space(40) + (parseInt(data.special.customerGrowPoint) + parseInt(data.pos[0].TOTAL * tmpFactory) + ' Pts').space(8,"s")});
                    tmpArr.push({font:"b",align:"lt",data:"EQUIVALENT REMISE ".space(40) + (decimal(parseFloat((parseInt(data.special.customerGrowPoint) + parseInt(data.pos[0].TOTAL)) / 100).toFixed(2)).toString() + 'EUR').space(8,"s")});
                ...
                else
                {
                    tmpArr.push({align:"ct",barcode:data.pos[0].CUSTOMER_CODE,options:{width: 1,height:30}});
                    tmpArr.push({font:"b",style:"b",align:"lt",data:"************************************************".space(48)});
                    tmpArr.push({font:"b",align:"ct",data:(data.pos[0].CUSTOMER_NAME).space(48)});
                    tmpArr.push({font:"b",align:"lt",data:(" ").space(48)});
                    tmpArr.push({font:"b",align:"lt",data:(" ").space(48)});
                    tmpArr.push({font:"b",align:"lt",data:("SIGNATURE: ").space(48)});
                    tmpArr.push({font:"b",align:"lt",data:("......................NOM:......................").space(48)});
                    tmpArr.push({font:"b",style:"b",align:"lt",data:"************************************************".space(48)});
                }
            }
            return tmpArr.length > 0 ? tmpArr : undefined
        ...
        ()=>
        {
            if(data.special.type == 'Fatura')
            {
                return {font:"a",style:"b",align:"ct",data:data.special.factCertificate}
            }
            else
            {
