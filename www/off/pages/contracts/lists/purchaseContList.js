                            ...
                            <Form colCount={2} id="frmCriter">
                                <Item>
                                    <Label text={this.t("cmbCustomer")} alignment="right" />
                                        ...
                                        value=""
                                        data={{source: {select : {query:"SELECT CUSTOMER_CODE,CUSTOMER_NAME FROM ITEM_PRICE_VW_01 WHERE TYPE = 1 GROUP BY  CUSTOMER_NAME,CUSTOMER_CODE ORDER BY CUSTOMER_NAME ASC"},sql : this.core.sql}}}
