                            ...
                            <Form colCount={2} id="frmCriter">
                                ...
                                <Item>
                                    <Label text={this.t("cmbCustomer")} alignment="right" />
                                        ...
                                        value=""
                                        data={{source: {select : {query:"SELECT INPUT_CODE,INPUT_NAME FROM DOC_VW_01 WHERE TYPE = 1 AND DOC_TYPE = 40 AND REBATE = 1 GROUP BY  INPUT_NAME,INPUT_CODE ORDER BY INPUT_NAME ASC"},sql : this.core.sql}}}
